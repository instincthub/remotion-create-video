...
/**
 * "What you'll learn" agenda card, shown while the instructor frames the
 * lesson. A numbered list in a frosted gunmetal panel on the left, each item
 * settling in turn. Number badges follow the brand's primary-button pattern:
 * DarkCyan fill + white text.
 */
