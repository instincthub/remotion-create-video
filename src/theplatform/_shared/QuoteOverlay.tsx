...
/**
 * Pull-quote / punchline card. A large opening quote mark in yellow (the
 * spark), the verbatim line in white, and the speaker attribution beneath.
 * Frosted ink panel on the lower-left; timed into gaps between chapter reveals
 * so it never stacks on another left-side panel.
 */
  ...
  return (
    ...
    >
      <div style={{ position: "relative", padding: "40px 48px 40px 52px", ...panel, borderRadius: 26 }}>
        ...
        >
          <div style={{ width: 44, height: 3, borderRadius: 999, background: colors.yellow }} />
          <div
            style={{
              fontFamily: overpass,
              fontWeight: 700,
