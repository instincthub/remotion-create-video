...
/**
 * Big animated figure callout for a statistic the speaker states (e.g. "120
 * stalls", "₦150m"). The number is rendered in yellow — the single spark, and
 * the one place a large yellow element is justified. Frosted ink panel,
 * lower-left.
 *
