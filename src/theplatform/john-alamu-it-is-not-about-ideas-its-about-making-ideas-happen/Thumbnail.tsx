...
/**
 * Course thumbnail (16:9) for "It Is Not About Ideas, It's About Making Ideas
 * Happen". The Platform identity: yellow canvas, ink bars, the lightbulb motif,
 * with John Alamu's portrait (a frame lifted from the keynote footage).
 * Rendered locally via `npx remotion still ja-thumbnail`.
 */
      ...
      <div style={{ position: "absolute", left: 96, bottom: 80, display: "flex", alignItems: "center", gap: 22 }}>
        ...
        <div>
          ...
          <div style={{ fontWeight: 600, fontSize: 31, color: colors.ink, opacity: 0.78, marginTop: 6 }}>
            Founder &amp; Group MD, CapitalSage Holdings
          </div>
        </div>
      </div>
