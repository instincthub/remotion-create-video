...
const DOT_COUNT = 7;
const ACTIVE_DOT = 2; // 0-indexed, dot 3 = index 2
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          style={{
            opacity: interpolate(ep4Label, [0, 1], [0, 1]),
            transform: `translateY(${interpolate(ep4Label, [0, 1], [24, 0])}px)`,
            fontSize: 80,
            fontWeight: 700,
            color: colors.white,
            textAlign: "center",
